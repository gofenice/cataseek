...
const Logo = ({ size = 22, color = "currentColor" }) => (
  <span style={{ display: "inline-flex", alignItems: "center", gap: 9, color }}>
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      {/* handle */}
      <path d="M14.6 14.6 L20 20" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
    <span style={{ fontSize: size * 0.85, fontWeight: 600, letterSpacing: "-0.022em" }}>cataseek</span>
  </span>
);
...
const SAMPLE_PRODUCTS = [
  { name: "Linen Camp Shirt â€” Sand",  price: "â‚¬48",  tag: "Apparel",   stock: "In stock",  img: IMG("1620799140408-edc6dcb6d633"), sizes: ["XS","S","M"],     colors: ["sand"]   },
  { name: "Linen Camp Shirt â€” Olive", price: "â‚¬48",  tag: "Apparel",   stock: "In stock",  img: IMG("1591047139829-d91aecb6caea"), sizes: ["S","M","L","XL","2XL"], colors: ["olive"]  },
  { name: "Linen Trouser â€” Bone",     price: "â‚¬72",  tag: "Apparel",   stock: "Low stock", img: IMG("1594633312681-425c7b97ccd1"), sizes: ["M","L"],         colors: ["bone"]   },
  { name: "Linen Wrap Dress",         price: "â‚¬118", tag: "Apparel",   stock: "In stock",  img: IMG("1490481651871-ab68de25d43d"), sizes: ["S","M"],          colors: ["ecru"]   },
  { name: "Cream Knit Sweater",       price: "â‚¬96",  tag: "Apparel",   stock: "In stock",  img: IMG("1612722432474-b971cdcea546"), sizes: ["S","M","L"],     colors: ["cream"]  },
  { name: "Wide-leg Trouser",         price: "â‚¬72",  tag: "Apparel",   stock: "In stock",  img: IMG("1434389677669-e08b4cac3105"), sizes: ["S","M","L","2XL"], colors: ["black"]  },
  { name: "Linen Tunic â€” Ecru",       price: "â‚¬86",  tag: "Apparel",   stock: "In stock",  img: IMG("1521572163474-6864f9cf17ab"), sizes: ["L","XL","2XL"],     colors: ["ecru"]   },
  { name: "Linen Set â€” Olive",        price: "â‚¬120", tag: "Apparel",   stock: "Low stock", img: IMG("1602810318383-e386cc2a3ccf"), sizes: ["S","M"],          colors: ["olive"]  },
  { name: "Linen Bucket Hat",         price: "â‚¬32",  tag: "Accessory", stock: "In stock",  img: IMG("1556306535-38febf6782e7"),    sizes: ["OS"],             colors: ["sand"]   },
  { name: "Cotton Tote â€” Natural",    price: "â‚¬18",  tag: "Accessory", stock: "In stock",  img: IMG("1597481499750-3e6b22637e12"), sizes: ["OS"],             colors: ["ecru"]   },
  { name: "Wool Beanie â€” Stone",      price: "â‚¬28",  tag: "Accessory", stock: "In stock",  img: IMG("1576871337622-98d48d1cf531"), sizes: ["OS"],             colors: ["stone"]  },
  { name: "Leather Belt â€” Tan",       price: "â‚¬54",  tag: "Accessory", stock: "In stock",  img: IMG("1624222247344-550fb60583dc"), sizes: ["S","M","L"],     colors: ["tan"]    }
];

const SAMPLE_SUGGESTIONS = ["linen shirt", "linen trousers", "linen bucket hat", "linen tote", "olive set", "size m"];
const SAMPLE_CATEGORIES  = ["Apparel Â· 124", "Accessories Â· 38", "Sale Â· 21"];

// Cycles through three different intents â€” keyword, color, size â€” to show Cataseek matches across attributes.
const TYPED_QUERIES = [
    ...
    <div className="browser" style={{ position: "relative" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {!typed && <span style={{ color: "var(--ink-3)" }}>Search productsâ€¦</span>}
          <span className="mono" style={{ marginLeft: "auto", fontSize: 10, color: "var(--ink-3)", border: "1px solid var(--line-2)", borderRadius: 4, padding: "0px 4px" }}>âŒ˜K</span>
        </div>
      </div>

      {/* storefront body â€” product grid; dropdown overlays this */}
      <div style={{
        position: "relative",
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12 }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
            ...
            <span className="mono" style={{ fontSize: 10.5, color: "var(--ink-3)", letterSpacing: ".05em" }}>
              {typed ? `${matchCount} of ${SAMPLE_PRODUCTS.length} match ${queryLabel} â€œ${typed}â€` : "32 styles"}
            </span>
          </div>
        ...
        {/* Catalog â€” fixed positions; non-matches dim. Mask the bottom so it feels like there are more rows. */}
        <div style={{
          position: "relative",
          maxHeight: 280,
          overflow: "hidden",
        ...
        {/* Dropdown â€” overlays the grid, anchored to the search field */}
        {matches.length > 0 && (
          <div style={{
            ...
            <div style={{ padding: "6px 0" }}>
              ...
              {matches.slice(0, 3).map((p, idx) => (
                <div key={p.name} style={{
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 10.5, color: "var(--ink-3)" }}>{p.tag} Â· {p.stock}</div>
                  </div>
              ...
              <div style={{ borderTop: "1px solid var(--line)", padding: "8px 12px", display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 10.5, color: "var(--ink-3)" }}>
                ...
                <span className="mono">â†µ view all</span>
              </div>
            </div>
          </div>
        )}
  ...
  <section style={{ paddingTop: 56, paddingBottom: 56 }}>
    <div className="wrap hero-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.05fr", gap: 56, alignItems: "center" }}>
      <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 540 }}>
        <span className="eyebrow"><span className="dot"/>v1.0 Â· Now in public beta</span>
        <h1 style={{
        ...
        <p style={{ fontSize: 16.5, color: "var(--ink-2)", maxWidth: 480, margin: 0, lineHeight: 1.5 }}>
          ...
          and a design that fits your brand â€” installed in under a minute.
        </p>
    ...
    <section style={{ padding: "48px 0" }}>
      <div className="wrap" style={{ display: "flex", flexDirection: "column", gap: 28 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 24, flexWrap: "wrap" }}>
          ...
          <span className="mono" style={{ fontSize: 12, color: "var(--ink-3)" }}>2 platforms live Â· 4 in roadmap</span>
        </div>
...
/* Abstract platform glyphs (NOT brand logos â€” original wordmark fragments) */
...
/* ============================================================
   ...
   ============================================================ */
const FEATURES = [
  { icon: "bolt",   tag: "01 / Speed",      title: "Sub-50ms results",        body: "Edge-cached index responds before the user finishes typing â€” even on catalogues over 100k SKUs." },
  ...
  { icon: "filter", tag: "04 / Refinement", title: "Faceted on the fly",      body: "Price, stock, category and custom attributes filter the result set instantly â€” no page reload, no skeletons." },
  ...
  <section id="features">
    <div className="wrap">
      <div className="section-head">
        ...
        <p>Everything teams ask us to add first â€” already in the box. Toggle off what you don't need.</p>
      </div>
...
const PLANS = [
  ...
  {
    name: "Growth",
    blurb: "Most popular â€” built for stores doing real volume.",
    price: 49,
    cta: "Start free trial",
    featured: true,
    feats: [
    ...
    <section id="pricing">
      <div className="wrap">
        <div className="section-head" style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end", maxWidth: "100%", flexWrap: "wrap", gap: 24 }}>
          ...
          <div style={{ display: "inline-flex", padding: 4, border: "1px solid var(--line)", borderRadius: 999, background: "var(--card)" }}>
            {[
              { id: false, label: "Monthly" },
              { id: true,  label: "Annual Â· -20%" }
            ].map(o => (
              <button key={String(o.id)} onClick={() => setAnnual(o.id)} style={{
                border: 0, background: annual === o.id ? "var(--ink)" : "transparent",
                color: annual === o.id ? "var(--bg)" : "var(--ink-2)",
            ...
            return (
              <div key={p.name} className={"price-card" + (p.featured ? " featured" : "")}>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
                  <span style={{ fontSize: 48, letterSpacing: "-0.03em", fontWeight: 500, lineHeight: 1 }}>â‚¬{monthly}</span>
                  <span style={{ fontSize: 13, color: p.featured ? "rgba(246,244,238,0.6)" : "var(--ink-3)" }}>/ month{annual ? ", billed yearly" : ""}</span>
                </div>
                <button className={p.featured ? "btn btn-accent btn-lg" : "btn btn-primary btn-lg"} style={{ justifyContent: "center" }}>
                  {p.cta} <Icon.arrow/>
                </button>
        ...
        <div style={{ textAlign: "center", marginTop: 28, color: "var(--ink-3)", fontSize: 13 }} className="mono">
          All plans include 14-day free trial Â· No setup fees Â· VAT calculated at checkout
        </div>
      </div>
    </section>
  );
...
const FAQS = [
  ...
  { q: "Will it slow down my store?",
    a: "No â€” Cataseek runs from your customers' nearest edge node and never blocks page rendering. The plugin itself adds about 6KB of JavaScript, loaded async." },
  ...
  { q: "Do you support PrestaShop and WooCommerce equally?",
    a: "Yes. Both plugins are first-class and ship feature parity. Other platforms â€” Shopify, Magento, BigCommerce, OpenCart â€” are on the public roadmap for 2026." },
      ...
      <div className="wrap" style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: 56 }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 18, position: "sticky", top: 100, alignSelf: "start" }}>
          ...
          <p style={{ color: "var(--ink-2)", margin: 0 }}>
            Can't find what you're looking for? <span style={{ borderBottom: "1px solid var(--ink)", cursor: "pointer" }}>Email the team â†’</span>
          </p>
        </div>
        <div>
          {FAQS.map((f, i) => (
...
const Footer = () => (
  <footer>
    <div className="wrap" style={{ display: "grid", gridTemplateColumns: "1.6fr repeat(4, 1fr)", gap: 40 }}>
      ...
      <div>
        <h5>Platforms</h5>
        <ul><li>WooCommerce</li><li>PrestaShop</li><li>Shopify <span className="mono" style={{ color: "#5C5A53", fontSize: 11 }}> Â· soon</span></li><li>Magento <span className="mono" style={{ color: "#5C5A53", fontSize: 11 }}> Â· soon</span></li></ul>
      </div>
      <div>
        <h5>Resources</h5>
        <ul><li>Documentation</li><li>Help center</li><li>Status</li><li>Contact</li></ul>
      </div>
      <div>
        <h5>Company</h5>
        <ul><li>About</li><li>Customers</li><li>Privacy</li><li>Terms</li></ul>
      </div>
    </div>
    <div className="wrap" style={{ marginTop: 56, paddingTop: 24, borderTop: "1px solid #2A2825", display: "flex", justifyContent: "space-between", alignItems: "center", color: "#5C5A53", fontSize: 12.5 }} className="mono">
      <span className="mono">Â© 2026 Cataseek Labs Â· v1.0.4</span>
